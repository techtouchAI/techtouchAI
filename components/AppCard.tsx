...
export default function AppCard({ app }: AppCardProps) {
  ...
  return (
    <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden hover:shadow-md transition-shadow group flex flex-col">
      <div
        className="relative aspect-square cursor-pointer overflow-hidden bg-gray-50 flex-shrink-0"
      ...
      <div className="p-3 sm:p-4 flex-grow flex flex-col justify-center">
        <h3 className="font-bold text-gray-900 text-sm sm:text-base line-clamp-1 mb-1 text-center">
          {app.name}
        </h3>
        {app.description && (
